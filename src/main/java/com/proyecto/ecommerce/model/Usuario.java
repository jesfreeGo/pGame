...
@Entity
@Table(name = "usuarios")  //se modifica el nombre de la tabla a 'usuarios'
public class Usuario {
	...
	//constructor que recibe todos los atributos por parametro para consulta o modificacion
	public Usuario(Integer id, String nombre, String username, String correo, String direccion, String telefono,
	...
	//toString para mostrar los datosrecibidos 
	@Override
